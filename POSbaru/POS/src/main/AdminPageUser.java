 ...
 * @author ASUS
 */
public class AdminPageUser extends javax.swing.JFrame {
    ...
    public AdminPageUser(UserProfile P) {
        initComponents();
...
//            JOptionPane.showMessageDialog(this, id); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPageUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPageUser().setVisible(true);
            }
        });
    }
