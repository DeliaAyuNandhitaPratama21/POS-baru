...
//            JOptionPane.showMessageDialog(this, id); 
    ...
    private void btnUbahProdukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahProdukActionPerformed
        ...
        if(n != -1){
            int id = Integer.parseInt(Tabel2.getValueAt(n, 0).toString());
            String KP = Tabel2.getValueAt(n, 1).toString();
            String NP = Tabel2.getValueAt(n, 2).toString();
            String GP = Tabel2.getValueAt(n, 3).toString();
            String KAP = Tabel2.getValueAt(n, 4).toString();
            String SUP = Tabel2.getValueAt(n, 5).toString();
            String HJ = Tabel2.getValueAt(n, 6).toString();
            String HB = Tabel2.getValueAt(n, 7).toString();
            String SP = Tabel2.getValueAt(n, 8).toString();
    ...
    public static void viewProduk(String where) {
        ...
        try {
            ...
            while (R.next()) {                 
                ...
                Object[] data = {n, id,kode_produk, nama_produk, gambar_produk,
